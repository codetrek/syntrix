...
| Proposed [admission limits](../../proposed/bug-fix/2026-09-07-puller-pending-write-bound.md) | The [Puller publication redesign](../../rejected/architecture/2026-09-07-puller-persist-before-publish.md) is rejected; admission limits remain proposed. Store checkpoints must remain portable and source-owned, and cache completion cannot define consumer checkpoint validity |
