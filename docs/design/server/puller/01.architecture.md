...
The [capture failure decision](../../../../.agents/notes/implemented/bug-fix/2026-09-08-puller-capture-failures.md) owns these error paths. Consumer-visible history failures and coordinated rebuild remain separate recovery work.
