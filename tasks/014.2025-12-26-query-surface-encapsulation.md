...
|------|-------------|------------|
| [015.index-layer-implementation](015.2025-12-29-index-layer-implementation.md) | Index layer with btree, OrderKey encoding, templates, rebuild | This task (014) |
| [016.change-stream-puller](016.2025-12-29-change-stream-puller.md) | Change stream puller, fan-out, checkpoints, JetStream | Task 015 |
...
- ❌ Index layer (btree, OrderKey, templates) → Task 015
- ❌ Data layer (change stream emission) → Task 015
- ❌ Query config expansion → Task 015
- ❌ Change stream puller → Task 016
...
## Deferred Execution Steps (Task 015 - Index Layer)
...
## Deferred Execution Steps (Task 016 - Puller)
